Date.getDateFrom = function (d, m, y) {
	return new Date(d + " " + ( typeof m =="string" ? m : this.CultureInfo.monthNames[m]) + " " + y).clearTime();
};
Date.CultureInfo = {
	name: "en-US",
...
Date.parseAnyFormat = function (a) {
	var b = null;
	if (!a) {
		return null
	}
