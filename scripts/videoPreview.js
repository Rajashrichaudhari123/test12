...
var cloumnName = $request.getParameter("Column_Name");
...
try {
		var response = fileLib.getFile("PDC_Video_Details",cloumnName,[{"column":"Application_Number","operator":"EQ","value":appno,"datatype":"string"}],"test","video/mp4");
